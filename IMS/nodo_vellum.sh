...
cat nodo_vellum >> clearwater/local_config 
...
echo "Editar archivo Shared_Config con la siguiente información"
cat shared_config_testbed_1
cat shared_config_testbed_1 >> $shared_config 
